...
const menuItems = [
  ...
  { icon: Sparkles, label: "الخدمات", path: "/dashboard?tab=services" },
  { icon: FileImage, label: "الأعمال", path: "/dashboard?tab=projects" },
  { icon: MessageSquareQuote, label: "التقييمات", path: "/dashboard?tab=reviews" },
  { icon: ClipboardList, label: "الطلبات", path: "/dashboard?tab=leads" },
];
